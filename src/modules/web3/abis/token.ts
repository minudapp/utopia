export const abi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "newMinerAddress", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "newMinerFee", type: "uint256" }],
    name: "setMinerFee",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
