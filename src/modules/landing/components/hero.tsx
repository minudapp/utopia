...
import utopiaMobile from "@/assets/images/utopia_logo_mobile.png";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-1 flex h-full flex-col">
        <div className="relative z-1 flex flex-col items-center px-[10svw] pt-[25svh] md:pt-[10svh]">
          <Title />
        ...
        <div className="relative mx-auto h-full w-full">
          <Image
            src={utopia}
            alt="Utopia"
            className="absolute bottom-0 left-0 z-2 hidden object-contain lg:block lg:h-auto lg:max-h-96 lg:w-full"
          />
          <Image
            src={utopiaMobile}
            alt="Utopia"
            className="absolute bottom-0 left-0 z-2 h-auto w-full object-contain lg:hidden"
          />
        </div>
      </div>
    </section>
